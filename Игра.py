        ...
        self.programming_levels = [
            {
                "id": 1,
                "name": "Привет, Мир!",
                "description": "Научись выводить первое сообщение Hello, world",
                "theory": "В программировании первая программа - вывод текста Hello, world на экран. print() - это функция для вывода, чтобы вывести текст нужно записать текст в ковычки.",
                "static_parts": [
        ...
        self.electronics_levels = [
            {
                ...
                """,
                "task": "Нарисуйте принципиальную схему последовательной цепи с батареей, лампочкой и проводом(ответ писать в без запятых, через пробел c заглавной буквы)",
